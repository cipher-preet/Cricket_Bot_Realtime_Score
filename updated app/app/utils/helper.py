...
# removing the cencored words from the user input
def remove_censored_words(user_input: str) -> str:
    # profanity.load_censor_words()
    """
    Remove censored words from the user input.
    """
    return profanity.censor(user_input, '*')
