...
class Userdetails():
    ...
    def verify_user_cookie(self, request: Request):
    ...
    def verify_and_login_user(self, data: LoginModel, response: Response):
        ...
        if not user:
            ...
            return {"message": "Login successful", "user_id": registered_user}  
        ...
        access_token = self.__create_access_token(
                    ...
                    {"phone": user["phone_number"], "user_id": str(user)}
                )
        response.set_cookie(key="access_token", value=access_token, httponly=True)
        
        # return {"message": "Login successful", "user_id": str(user["_id"])}
        return {"message": "Login successful", "user_id": user}
